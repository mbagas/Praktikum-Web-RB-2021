            ...
            <div class="col-12 d-flex justify-content-center">
                ...
                <form action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 mt-3">
                      ...
                      <input type="text" class="form-control" id="email" name="judul" value="{{$blog->judul}}">
                    </div>
                    <div class="mb-3">
                      <label for="pwd" class="form-label">Author :</label>
                      <input type="text" class="form-control" id="pwd" name="author" value="{{$blog->author}}" >
                    </div>
                    <div class="mb-3">
                      <label for="pwd" class="form-label">isi :</label>
                      <textarea name="isi" class="form-control" id="" cols="30" rows="10" required>{{$blog->isi}}</textarea>
